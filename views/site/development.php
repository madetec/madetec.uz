...
$this->title = 'Madetec Solution | Development';

?>


<!-- Start Header -->
<header class="valign header" data-color="#bd1206">

    <div class="bg-main-container bg-develop">
    ...
    <div class="col-md-6 contain-rgt-display-img" data-aos="fade-right"  data-aos-once="true">
        <div class="pic-development">    
            <img src="\img\new-img\large\head-container-img\Development-header.png" alt="" class="img-cover">
        </div>
    </div>
</header>
<!-- End Header==== -->
    ...
    <div class="top-descript-block-develop">
     ...
     <div class="container-text-bot row mt-30">
        <div class="left-text col-md-4" data-aos="fade-right" data-aos-delay="200" data-aos-once="true" data-aos-transition="800">
            <p class="title-text grey pt-10">Как создается продукт?</p>
            <p class="main-text-bot grey">Создание программного обеспечения любой сложности происходит поэтапно, каждый этап утверждается Вами. Каждый этап будет сопровождаться высококвалифицированными специалистами нашей организации.
			 </p>
        </div>
...
<!------ Направления Development ------>


 <section id="develoment-direction" class="develoment-direction container-sqr" data-scroll-index="2">
    ...
    <div class="container main-content-develop" >
        <div class="logo-head logo-head-develop row justify-content-center pt-10" data-aos="fade-up" data-aos-once="true" data-aos-transition="800">   	
            ...
            <span class="text-logo-head pt-0">development</span>
         </div>
...
<!-- Start Footer -->
<section class="footer bg-fonn-development">
