        ...
        <div class="text-center mt-30">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <h1>Digital-агентство, которое <span> МОЖЕТ </span> !</h1>
                </div>
            </div>
            ...
            <div class="left-nav">
                <ul>
                    ...
                    <li><a href="#" data-scroll-nav="3">Команда</a></li>
                </ul>
            </div>
            <!-- decor -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 offset-md-1 text-center">
                <h3 data-aos="fade-up" data-aos-once="true">Доверьте <span> процветание </span> своего бизнеса <span>профессионалам.</span>
                </h3>
                <p class="mt-30" data-aos="fade-up" data-aos-delay="100" data-aos-once="true"></p>Мы
                <span>слушаем,</span> а не слышим. Мы <span> понимаем,</span> а не киваем. Мы <span>создаем,</span> а не
                копируем. Мы заботимся о Вас и концентрируемся на том, чтобы
                <span> Ваш бизнес работал на Вас. </span></p>
            </div>
        </div>
        <div class="line"></div>
        <div class="row text-center">
            ...
            <div class="col-md-6 col-lg-4  mt-30">
                <div class="ww-content" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
                    ...
                    <h5>Брендинг</h5>
                    <ul class="list-services">
                        <li>Упаковка бизнеса</li>
                        <li>Интернет-маркетинг</li>
                        <li>Продвижение и лидогенерация</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mt-30">
                <div class="ww-content" data-aos="fade-up" data-aos-delay="100" data-aos-once="true">
                    ...
                    <ul class="list-services">
                        <li>CRM - системы</li>
                        <li>Онлайн-магазины</li>
                        <li>Системы товароучета</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mt-30">
            ...
            <div class="col-md-6 col-lg-4 mt-30">
                <div class="ww-content" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
                    ...
                    <ul class="list-services">
                        <li>Легко понять</li>
                        <li>Легко поменять</li>
                        <li>Легко перенастроить</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid bg-second">
        <div class="row mt-100 v-center">
            ...
            <div class="col-md-12 col-lg-4 mmt-20 about-detail pb-30">
                <h3 class="mt-30">Профессиональные <span>Разработчики</span> и <span>Маркетологи</span>
                    на страже <span>Вашего успеха</span>.</h3>
                <p class="white mt-30">Наша миссия - предоставить комплексное и качественное продвижение Вашего бизнеса
                    в сфере Digital и освободить Вас от необходимости вникать в сложные процессы или нанимать раздутый
                    штат ненужных сотрудников.</p>


                <a href="#0" class="main-button mt-30">
                    <span>Хочу сотрудничать!</span>
                </a>
            </div>
        </div>
    </div>
...
<section class="portfolio bg-main" data-scroll-index="2">
    <div class="container">
        ...
        <h3 class="text-center" data-aos="fade-up" data-aos-delay="100" data-aos-once="true">
            <span> Уникальные проекты</span></h3>
        <div class="line"></div>
        ...
        <div class="owl-carousel owl-theme">
                ...
                <div class="row  v-center">
                    ...
                    <div class="col-md-12 col-lg-5">
                        ...
                        <ul class="mt-30">
                            ...
                            <li><span>Категория </span> : &nbsp; CRM-системы</li>
                        </ul>
            ...
            <div class="portfolio-item">
                <div class="row v-center">
                    ...
                    <div class="col-md-12 col-lg-5">
                        <h3 class="mt-20"><span>Watch Vault</span>
                            - <span> приложение </span> для <span>онлайн-торговли</span></h3>
                        <p class="mt-20">Watch Vault направлен на объединение продавцов, коллекционеров и покупателей
                            часов по всему миру. Приложение находится на стадии разработки и тестирования. </p>
                        <ul class="mt-30">
                            <li><span>Год запуска </span> : &nbsp; 2019</li>
            ...
            <div class="portfolio-item">
                <div class="row v-center">
                    ...
                    <div class="col-md-12 col-lg-5">
                        <h3 class="mt-20"><span>GECO Innovations</span> -
                            полный <span> Брендинг </span> и <span> Маркетинг </span> для новой компании на рынке </h3>
                        <p class="mt-20">Для компании GECO Innovations был разработан фирменный стиль, собственный сайт
                            с полным описанием предоставляемых услуг, а также были проведены работы над маркетинговой
                            стратегией, узнаваемостью бренда и привлечением клиентов с помощью социальных сетей.</p>
                        <ul class="mt-30">
                            <li><span>Год запуска </span> : &nbsp; 2018</li>
...
<section class="team bg-second" data-scroll-index="3">
    <div class="container">
        ...
        <h3 class="text-center" data-aos="fade-up" data-aos-delay="100" data-aos-once="true">
            <span> Невероятная Команда</span></h3>
        <div class="line"></div>
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme">
...
<section class="testimonial bg-main" data-scroll-index="4">
    <div class="container">
        ...
        <h3 class="text-center" data-aos="fade-up" data-aos-delay="100" data-aos-once="true"><span> Отзывы клиентов о работе с нами</span>
        </h3>
        <div class="line"></div>
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme">
                    <div class="testimonial-item">
                        <div class=" testimonial-content">
                            <p class="pb-20">Ipsum curae curabitur dapibus non netus dolor ante ut laoreet, turpis
                                faucibus sodales euismod conubia taciti quisque vestibulum, vitae adipiscing bibendum
                                himenaeos loportis dictum etiam.</p>
            ...
            <div class="col-lg-12">
                <div class="owl-carousel owl-theme">
                    <div class="partner-item">
                        <img src="/img/partner/partner-1.png" alt="part-1">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 data-aos="fade-up" data-aos-delay="300" data-aos-once="true">Хотите, чтобы мы воплотили Ваши идеи в
                    жизнь?</h2>
                <h4 data-aos="fade-up" data-aos-delay="100" data-aos-once="true">Поделитесь с нами задумкой и мы
                    обязательно свяжемся с Вами в течение часа!</h4>
...
<section class="contact bg-main" data-scroll-index="6">
    <div class="container">
        ...
        <h3 class="text-center" data-aos="fade-up" data-aos-delay="100" data-aos-once="true">
            <span>Место для Ваших идей</span></h3>
        <div class="line"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
                                    <input id="form_phone" type="tel" name="phone" size="20" minlength="9"
                                           maxlength="14" placeholder="Номер телефона">
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="main-button"><span>Отправить и ждать звоночка</span>
                                </button>
                            </div>
...
<section class="footer bg-second">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 border">
                <div class="address">
                    ...
                    <h4>Мы здесь</h4>
                    <p>Узбекистан, г.Ташкент, ул. Нуронийлар, 32, 3й этаж, кабинет №8</p>
                </div>
            </div>
        ...
        <div class="row mt-30 text-center">
            <div class="col-md-12">
                <p>&copy; Copyright 2018 Cingunt Themes</p>
            </div>
