...
<!-- Start Header -->
<header class="valign header" data-color="#040e75">

    <div class="bg-main-container bg-digital">
...
<section id="digital-product" class="digital-product" data-scroll-index="1">
    <div class="container">
...
<!-- Clients Start -->
<section id="clients" class="companys-clients" data-scroll-index="3">
    <h2 class="text-center text-dark font-weight-bold">Наши клиенты</h2>
...
<!-- Start Footer -->
<section class="footer bg-fon-digital">
